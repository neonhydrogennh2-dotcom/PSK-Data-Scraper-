...
## Key Learnings Intercepting XHR/Fetch: 
Learned that modern websites often load data via background requests. Bypassing the main URL to hit the data source directly is faster and more reliable.
